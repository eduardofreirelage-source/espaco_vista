...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let isDirty = false;
    let currentItemIndex = null; // Para o popover
    ...
    function renderQuoteCategories() {
        ...
        CATEGORY_ORDER.forEach(categoryName => {
            ...
            if (!categoryBlock) {
                console.error('Elemento .category-block não encontrado no template.');
                return;
            }
            ...
            if(tableBody) renderTableForCategory(tableBody, categoryName, groupedItems[categoryName] || []);
